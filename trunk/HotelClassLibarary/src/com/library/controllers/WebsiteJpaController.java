...
public class WebsiteJpaController implements Serializable {
    ...
    public WebsiteJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Website website) throws PreexistingEntityException, Exception {
    ...
    public void edit(Website website) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
