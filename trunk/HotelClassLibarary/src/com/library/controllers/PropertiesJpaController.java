...
public class PropertiesJpaController implements Serializable {
    ...
    public void create(Properties properties) throws PreexistingEntityException, Exception {
    ...
    public void edit(Properties properties) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
