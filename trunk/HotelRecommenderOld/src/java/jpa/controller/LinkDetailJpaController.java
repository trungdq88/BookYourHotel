...
public class LinkDetailJpaController implements Serializable {
    ...
    public LinkDetailJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(LinkDetail linkDetail) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findLinkDetail(linkDetail.getLinkDetailID()) != null) {
                throw new PreexistingEntityException("LinkDetail " + linkDetail + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(LinkDetail linkDetail) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
