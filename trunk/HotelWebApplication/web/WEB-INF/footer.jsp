<%-- 
    Document   : footer
    Created on : Oct 13, 2013, 11:03:24 AM
    Author     : Quang Trung
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <footer>
            <div class="wrap clearfix">
                ...
                <article class="one-fourth">
                    ...
                    <p>FPT University, SE0765</p>
                    <p><em>T:</em> Dinh Quang Trung</p>
                    <p><em>H:</em> Pham Thi Thu Hoa</p>
                    <p><em>T:</em> Huynh Quang Thao</p>
                    <p><em>M:</em> Le Tai Nhat Minh</p>
                </article>
                <!--//column-->
                ...
                <section class="bottom">
                    <p class="copy">Copyright 2013 Book your hotel ltd. All rights reserved</p>
                    <nav>
                        <ul>
        ...
        <script type="text/javascript">
            ...
            var _gaq = _gaq || [];
            _gaq.push(['_setAccount', 'UA-37606232-1']);
